...
class C extends Component {
  ...
  onOwnerRegistration = (e) => {
    e.preventDefault();
    this.processSignup("ROLE_ADMIN");
  }
        ...
        <div style={{ display: "flex" }}>
          ...
          >
            ...
            <Form.Item>
              ...
              <Button
                type="primary"
                onClick={this.onOwnerRegistration} name='regowner'
                className="login-form-button"
              >
                Register As Owner
              </Button>
